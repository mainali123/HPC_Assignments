...
//    printf("%c %c %c %c = %s\n", genRawPass[0],genRawPass[1],genRawPass[2],genRawPass[3], CudaCrypt(genRawPass));   // change 1
}
...
int main(int argc, char ** argv){
    ...
    // Declare a raw password
    char rawPassword[] = "dm19";
    // call the CudaCrypt function to encrypt the raw password
